...
Revision ID: fe7e38e56c78
Revises: 
Create Date: 2024-07-29 18:28:09.263880
...
def upgrade():
    ...
    sa.Column('day_of_the_week', sa.String(length=50), nullable=False),
    ...
    op.create_table('user_calorie_log',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    ...
    sa.Column('routine_activity_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['routine_activity_id'], ['routine_activity.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('user_calorie_log')
